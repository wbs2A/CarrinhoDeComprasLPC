...
-- -----------------------------------------------------
-- Table `carrinho`.`endereco`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `carrinho`.`endereco` (
...
CREATE TABLE IF NOT EXISTS `carrinho`.`cliente` (
  ...
  CONSTRAINT `fk_cliente_endereco1`
    ...
    REFERENCES `carrinho`.`endereco` (`idendereco`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
CREATE TABLE IF NOT EXISTS `carrinho`.`compra` (
  ...
  CONSTRAINT `fk_Compra_cliente1`
    ...
    REFERENCES `carrinho`.`cliente` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `carrinho`.`imagem` (
  `idimagem` INT(11) NOT NULL AUTO_INCREMENT,
  `caminho` VARCHAR(45) NOT NULL,
  `Produto_idProduto` INT(11) NOT NULL,
  PRIMARY KEY (`idimagem`),
  INDEX `fk_imagem_Produto1_idx` (`Produto_idProduto` ASC),
  CONSTRAINT `fk_imagem_Produto1`
    FOREIGN KEY (`Produto_idProduto`)
    REFERENCES `carrinho`.`produto` (`idProduto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `carrinho`.`login` (
  ...
  `cliente_id` INT(11) NOT NULL,
  PRIMARY KEY (`cpf`),
  INDEX `fk_login_cliente1_idx` (`cliente_id` ASC),
...
-- -----------------------------------------------------
-- Table `carrinho`.`produto_has_compra`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `carrinho`.`produto_has_compra` (
  `Produto_idProduto` INT(11) NOT NULL,
  `Compra_idCompra` INT(11) NOT NULL,
  `quantidade` INT NOT NULL,
  PRIMARY KEY (`Produto_idProduto`, `Compra_idCompra`),
  INDEX `fk_Produto_has_Compra_Compra1_idx` (`Compra_idCompra` ASC),
  INDEX `fk_Produto_has_Compra_Produto1_idx` (`Produto_idProduto` ASC),
  CONSTRAINT `fk_Produto_has_Compra_Compra1`
    FOREIGN KEY (`Compra_idCompra`)
    REFERENCES `carrinho`.`compra` (`idCompra`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `carrinho`.`telefone`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `carrinho`.`telefone` (
...
--
INSERT INTO `estado` (`Id`, `Nome`, `Uf`, `IBGE`, `UF_SL`, `UF_DDD`) VALUES
(1, 'Acre', 'AC', 12, 1, '68'),
...
INSERT INTO `imagem`(`caminho`, `Produto_idProduto`) VALUES ("../images/product_4.png",4);
INSERT INTO `imagem`(`caminho`, `Produto_idProduto`) VALUES ("../images/product_5.png",5);
INSERT INTO `imagem`(`caminho`, `Produto_idProduto`) VALUES ("../images/product_6.png",6);
...
INSERT INTO `compra`(`estado`,  `cliente_id`) VALUES ("Nocarrinho",1);
